...
VALUES
    ...
    ('john_doe', 0, 'john123', 'john.doe@email.com', 'john_profile.jpg', CURRENT_TIMESTAMP),
    ('alice_smith', 0, 'alice456', 'alice.smith@email.com', 'alice_profile.jpg', CURRENT_TIMESTAMP),
    ('bob_jones', 0, 'bob789', 'bob.jones@email.com', 'bob_profile.jpg', CURRENT_TIMESTAMP),
    ('sarah_miller', 0, 'sarah456', 'sarah.miller@email.com', 'sarah_profile.jpg', CURRENT_TIMESTAMP),
    ('david_wilson', 0, 'david789', 'david.wilson@email.com', 'david_profile.jpg', CURRENT_TIMESTAMP),
    ('emily_parker', 0, 'emily123', 'emily.parker@email.com', 'emily_profile.jpg', CURRENT_TIMESTAMP),
    ('michael_taylor', 0, 'michael789', 'michael.taylor@email.com', 'michael_profile.jpg', CURRENT_TIMESTAMP),
    ('olivia_clark', 0, 'olivia456', 'olivia.clark@email.com', 'olivia_profile.jpg', CURRENT_TIMESTAMP),
    ('ryan_hall', 0, 'ryan123', 'ryan.hall@email.com', 'ryan_profile.jpg', CURRENT_TIMESTAMP),
    ('grace_turner', 0, 'grace456', 'grace.turner@email.com', 'grace_profile.jpg', CURRENT_TIMESTAMP),
    ('alice_doe', 0, 'password123', 'alice@example.com', 'profile_alice.jpg', CURRENT_TIMESTAMP),
    ('bob_smith', 0, 'bobpass456', 'bob@example.com', 'profile_bob.jpg', CURRENT_TIMESTAMP),
    ('carol_jones', 0, 'carolpass789', 'carol@example.com', 'profile_carol.jpg', CURRENT_TIMESTAMP),
    ('dave_miller', 0, 'davepass321', 'dave@example.com', 'profile_dave.jpg', CURRENT_TIMESTAMP),
    ('emma_white', 0, 'emmapass654', 'emma@example.com', 'profile_emma.jpg', CURRENT_TIMESTAMP),
    ('frank_brown', 0, 'frankpass987', 'frank@example.com', 'profile_frank.jpg', CURRENT_TIMESTAMP),
    ('grace_taylor', 0, 'gracepass123', 'grace@example.com', 'profile_grace.jpg', CURRENT_TIMESTAMP),
    ('harry_wilson', 0, 'harrypass456', 'harry@example.com', 'profile_harry.jpg', CURRENT_TIMESTAMP),
    ('isabel_green', 0, 'isabelpass789', 'isabel@example.com', 'profile_isabel.jpg', CURRENT_TIMESTAMP),
    ('jack_smith', 0, 'jackpass321', 'jack@example.com', 'profile_jack.jpg', CURRENT_TIMESTAMP),
    ('kate_jones', 0, 'katepass654', 'kate@example.com', 'profile_kate.jpg', CURRENT_TIMESTAMP),
    ('liam_davis', 0, 'liampass987', 'liam@example.com', 'profile_liam.jpg', CURRENT_TIMESTAMP),
    ('maya_anderson', 0, 'mayapass123', 'maya@example.com', 'profile_maya.jpg', CURRENT_TIMESTAMP),
    ('nathan_baker', 0, 'nathanpass456', 'nathan@example.com', 'profile_nathan.jpg', CURRENT_TIMESTAMP),
    ('olivia_carter', 0, 'oliviapass789', 'olivia@example.com', 'profile_olivia.jpg', CURRENT_TIMESTAMP),
    ('peter_evans', 0, 'peterpass321', 'peter@example.com', 'profile_peter.jpg', CURRENT_TIMESTAMP),
    ('quinn_fisher', 0, 'quinnpass654', 'quinn@example.com', 'profile_quinn.jpg', CURRENT_TIMESTAMP),
    ('ryan_yang', 0, 'ryanpass987', 'ryan@example.com', 'profile_ryan.jpg', CURRENT_TIMESTAMP),
    ('sophie_irwin', 0, 'sophiepass123', 'sophie@example.com', 'profile_sophie.jpg', CURRENT_TIMESTAMP),
    ('tom_king', 0, 'tompass456', 'tom@example.com', 'profile_tom.jpg', CURRENT_TIMESTAMP),
    ('hiroshi', 0, 'hiroshi123', 'hiroshi@example.com', 'profile_hiroshi.jpg', CURRENT_TIMESTAMP),
    ('akiko', 0, 'akiko456', 'akiko@example.com', 'profile_akiko.jpg', CURRENT_TIMESTAMP),
    ('takeshi', 0, 'takeshi789', 'takeshi@example.com', 'profile_takeshi.jpg', CURRENT_TIMESTAMP),
    ('yuki', 0, 'yuki123', 'yuki@example.com', 'profile_yuki.jpg', CURRENT_TIMESTAMP),
    ('sakura', 0, 'sakura456', 'sakura@example.com', 'profile_sakura.jpg', CURRENT_TIMESTAMP),
    ('taro', 0, 'taro789', 'taro@example.com', 'profile_taro.jpg', CURRENT_TIMESTAMP),
    ('naoko', 0, 'naoko123', 'naoko@example.com', 'profile_naoko.jpg', CURRENT_TIMESTAMP),
    ('ryota', 0, 'ryota456', 'ryota@example.com', 'profile_ryota.jpg', CURRENT_TIMESTAMP),
    ('ayumi', 0, 'ayumi789', 'ayumi@example.com', 'profile_ayumi.jpg', CURRENT_TIMESTAMP),
    ('kenta', 0, 'kenta123', 'kenta@example.com', 'profile_kenta.jpg', CURRENT_TIMESTAMP),
    ('miho', 0, 'miho456', 'miho@example.com', 'profile_miho.jpg', CURRENT_TIMESTAMP),
    ('sora', 0, 'sora789', 'sora@example.com', 'profile_sora.jpg', CURRENT_TIMESTAMP),
    ('kazuki', 0, 'kazuki123', 'kazuki@example.com', 'profile_kazuki.jpg', CURRENT_TIMESTAMP),
    ('emiko', 0, 'emiko456', 'emiko@example.com', 'profile_emiko.jpg', CURRENT_TIMESTAMP),
    ('takahiro', 0, 'takahiro789', 'takahiro@example.com', 'profile_takahiro.jpg', CURRENT_TIMESTAMP),
    ('maiko', 0, 'maiko123', 'maiko@example.com', 'profile_maiko.jpg', CURRENT_TIMESTAMP),
    ('shinji', 0, 'shinji456', 'shinji@example.com', 'profile_shinji.jpg', CURRENT_TIMESTAMP),
    ('liuwei', 0, 'liuwei123', 'liuwei@example.com', 'profile_liuwei.jpg', CURRENT_TIMESTAMP),
    ('wangying', 0, 'wangying456', 'wangying@example.com', 'profile_wangying.jpg', CURRENT_TIMESTAMP),
    ('zhangwei', 0, 'zhangwei789', 'zhangwei@example.com', 'profile_zhangwei.jpg', CURRENT_TIMESTAMP),
    ('chenxin', 0, 'chenxin123', 'chenxin@example.com', 'profile_chenxin.jpg', CURRENT_TIMESTAMP),
    ('yangming', 0, 'yangming456', 'yangming@example.com', 'profile_yangming.jpg', CURRENT_TIMESTAMP),
    ('xuxin', 0, 'xuxin789', 'xuxin@example.com', 'profile_xuxin.jpg', CURRENT_TIMESTAMP),
    ('lihong', 0, 'lihong123', 'lihong@example.com', 'profile_lihong.jpg', CURRENT_TIMESTAMP),
    ('zhaojie', 0, 'zhaojie456', 'zhaojie@example.com', 'profile_zhaojie.jpg', CURRENT_TIMESTAMP),
    ('sunlei', 0, 'sunlei789', 'sunlei@example.com', 'profile_sunlei.jpg', CURRENT_TIMESTAMP),
    ('wanglei', 0, 'wanglei123', 'wanglei@example.com', 'profile_wanglei.jpg', CURRENT_TIMESTAMP),
    ('chenxi', 0, 'chenxi456', 'chenxi@example.com', 'profile_chenxi.jpg', CURRENT_TIMESTAMP),
    ('yangyun', 0, 'yangyun789', 'yangyun@example.com', 'profile_yangyun.jpg', CURRENT_TIMESTAMP),
    ('linjun', 0, 'linjun123', 'linjun@example.com', 'profile_linjun.jpg', CURRENT_TIMESTAMP),
    ('huangwei', 0, 'huangwei456', 'huangwei@example.com', 'profile_huangwei.jpg', CURRENT_TIMESTAMP),
    ('xumin', 0, 'xumin789', 'xumin@example.com', 'profile_xumin.jpg', CURRENT_TIMESTAMP),
    ('zhouwei', 0, 'zhouwei123', 'zhouwei@example.com', 'profile_zhouwei.jpg', CURRENT_TIMESTAMP),
    ('lianghong', 0, 'lianghong456', 'lianghong@example.com', 'profile_lianghong.jpg', CURRENT_TIMESTAMP),
    ('wangxiao', 0, 'wangxiao789', 'wangxiao@example.com', 'profile_wangxiao.jpg', CURRENT_TIMESTAMP),
    ('fanyu', 0, 'fanyu123', 'fanyu@example.com', 'profile_fanyu.jpg', CURRENT_TIMESTAMP),
    ('xulian', 0, 'xulian456', 'xulian@example.com', 'profile_xulian.jpg', CURRENT_TIMESTAMP);
